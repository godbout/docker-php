...
```
docker run --rm -v /path/tiki-source:/var/www/html -w /var/www/html -it tikiwiki/php:7-cli psysh
...
```
docker run --rm -e XDEBUG=1 -v /path/tiki-source:/var/www/html -w /var/www/html -it tikiwiki/php:7-cli psysh
```
